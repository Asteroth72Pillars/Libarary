...
public class Rental implements Serializable {
    ...
    public Rental (int  rentalNumber, String dateRented, int studNumber , int isbNumber) {
        this.reffNumber = rentalNumber;
        this.dateRented = dateRented;
        this.dateReturned = "NA";
//        this.pricePerDay = pricePerDay;
        this.studentNo = studNumber;
        this.isbn = isbNumber;
//        determineTotalPenaltyCost();
    }

     public Rental (int  rentalNumber, String dateRented, String dateReturned,
                    int studNumber , int isbNumber) {
        this.reffNumber = rentalNumber;
        this.dateRented = dateRented;
//        this.pricePerDay = pricePerDay;
...
//    }
    ...
    public void setCustNumber(int sn)
    {
        this.studentNo = sn;        
    }
    public void setdvdNumber(int book)
    {
        this.isbn =book;        
    }
    ...
    public String toString() {
        return "Rental#:" + reffNumber + "  Date Rented:" + dateRented + "   Date Returned:" + dateReturned + "\nPenalty cost per day:R" + PENALTY_COST_PER_DAY + "  Total Penalty Cost:R" +
            totalPenaltyCost + "  Student#:" + studentNo + "  Book#:" + isbn +"\nNo of Days overdue:" + numberOfDaysOverdue()+"\n";
    }
